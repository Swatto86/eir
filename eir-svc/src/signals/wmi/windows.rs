...
/// SCM enumeration only — the manual "Refresh status" command's fast path (no
/// PowerShell), reused by [`super::rescan_failed_services`].
...
mod tests {
    use super::{
        effective_firewall, get_windows_update_status, nul_terminated_utf16, parse_defender_status,
        utf16_from_buffer,
    };
